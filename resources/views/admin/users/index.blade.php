                ...
                <tbody>
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <span
                                    class="inline-block px-2 py-1 font-semibold leading-tight rounded-full {{ $user->role === 'admin' ? 'bg-red-100 text-red-700' : ($user->role === 'petugas' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700') }}">
                                    {{ ucfirst($user->role) }}
                                </span>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
